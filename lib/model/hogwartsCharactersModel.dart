...
//
//     final hogwartsCharactersModel = hogwartsCharactersModelFromJson(jsonString);

import 'dart:convert';

List<HogwartsCharactersModel> hogwartsCharactersModelFromJson(String str) =>
    List<HogwartsCharactersModel>.from(
        json.decode(str).map((x) => HogwartsCharactersModel.fromJson(x)));

String hogwartsCharactersModelToJson(List<HogwartsCharactersModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class HogwartsCharactersModel {
  ...
  factory HogwartsCharactersModel.fromJson(Map<String, dynamic> json) =>
      HogwartsCharactersModel(
        id: json["id"],
        name: json["name"],
